...
print(str(normalize("файл 1.txt")))
    ...
    for filename in os.listdir(path): #список файлов внутри
        ...
        if os.path.isdir(file_path): #если папка, снова вызываем
            ...
            if file_ext in (".zip", ".gz", ".tar", ".rar"): 
                ...
                archive_folder = os.path.join(os.getcwd(), "archives", os.path.splitext(normalize(filename))[0]) #путь к папке архива
